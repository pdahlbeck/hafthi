...
Open **Preferences → Plugins**, then select **Fish** or **Starship** to see whether it is installed, change its settings, and visit its GitHub project. You can also turn either tool on or off in the Plugins overview. On Arch Linux, install either or both yourself:
